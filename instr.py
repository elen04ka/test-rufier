...
text_next = "Почати"
txt_instruction = ("Ця програма дозволить вам за допомогою тесту Руф'є провести первинну діагностику вашого стану здоров'я.\n"
                   "Проба Руф'є є навантажувальним комплексом, призначеним для оцінки працездатності серця при фізичному навантаженні.\n"
                   "У випробуваного, що знаходиться в положенні лежачи на спині протягом 5 хв, визначнють частоту пульсу за 15 секунд.\n"
                   ...
                   "в вухах, сильна задишка та ін.), то тест необхідно перервати і звернутися до лікаря.")
txt_title = "Здоров'я"
...
txt_test3 = "Лягте на спину і заміряйте пульс спочатку за перші 15 секунд хвилини, потім за останні 15 секунд хвилини без виміру пульсацій. Результат запишіть."
txt_hinttest1 = "0"
txt_hinttest2 = "0"
txt_hinttest3 = "0"
...
txt_timer = ''
txt_sendresault = 'Надіслати результати'
